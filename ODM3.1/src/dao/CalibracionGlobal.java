...
public class CalibracionGlobal {
    ...
    public static int L_VALOR_TOTAL_2=0;
    public static int L_ABONO=0;
    public static int L_SALDO=0;
        ...
        try {
            ...
            for (int temp = 0; temp < filas.getLength(); temp++) {
                ...
                if(nodo.getNodeType() == Node.ELEMENT_NODE){
                    ...
                    L_VALOR_TOTAL_2         = Integer.parseInt(element.getElementsByTagName("valor_total_2").item(0).getTextContent());
                    L_ABONO                 = Integer.parseInt(element.getElementsByTagName("abono").item(0).getTextContent());
                    L_SALDO                 = Integer.parseInt(element.getElementsByTagName("saldo").item(0).getTextContent());
