...
public class UserDao {
    ...
    public ArrayList<User> listar(int id) throws SQLException, ClassNotFoundException{
        String sql="SELECT * FROM `user` WHERE `us_id`='"+id+"' ";
        if(id==0){
    ...
    public User validar(String user, String pass) throws SQLException, ClassNotFoundException {
